...
<h1>El <abbr title="«Document Object Model», Modelo de Objeto de Documento">DOM</abbr></h1>
    ...
    <body>
        ...
        <p>Otro párrafo</p>
            ...
            <dl className="ilustracion">
                <dt><img src="/static/arbol_DOM.png" alt="" width="800" height="350"></img></dt>
            ...
            <p className="nota-importante">Una ventaja de esta interfaz es que la manera de trabajar con ella es análoga a la forma de <a href="curso_3_3.php#selec-descen">emplear selectores de <abbr title="«Cascading Style Sheets», Hojas de Estilo en Cascada">CSS</abbr> basados en el árbol de parentesco</a> que ya vimos.</p>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>Sí<sup className="nota"><a href="#nota02" id="texto02">2</a></sup></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>Sí<sup className="nota"><a href="#nota03" id="texto03">3</a></sup></td>
                </tr>
                <tr>
            ...
            <table>
                ...
                <tbody><tr>
                    <th scope="col">Tipo de nodo</th><th scope="col">Constante<sup className="nota"><a href="#nota04" id="texto04">4</a></sup></th><th scope="col">Número</th>
                </tr>
                <tr>
                    <td><code>Element</code></td>
                ...
                <li><abbr>DOM</abbr> 1:
                    <ul>
                        ...
                        <li>
                            ...
                            <p className="nota-importante">Sobre la inconsistencia del soporte de Explorer para estos dos métodos, ver <a href="../articulos/2007/set_y_getattribute_ie6.php">«Una nota sobre el soporte de getAttribute y setAttribute en Internet Explorer 6»</a>.</p>
                        </li>
                    </ul>
                </li>
                <li><abbr>DOM</abbr> 2:
            ...
            <h2>Notas</h2>
            <ol id="notas">
                <li id="nota01">Existen otras <abbr>API</abbr> para <abbr>XML</abbr>, como <abbr title="«Simple API for XML», API Simple para XML">SAX</abbr>. <a href="#texto01" className="volver"><img src="/static/volver.png" alt="Volver"></img></a></li>
                <li id="nota02">Éste es el único tipo de nodo que puede tener como hijo uno del tipo <code>attr</code>. <a href="#texto02" className="volver"><img src="/static/volver.png" alt="Volver"></img></a></li>
                <li id="nota03">Sólo acepta como hijos nodos de tipo <code>Text</code>. <a href="#texto03" className="volver"><img src="/static/volver.png" alt="Volver"></img></a></li>
                <li id="nota04">El número devuelto por <code>nodeType</code> es una referencia; estrictamente, al mapear el árbol del documento es una constante la que se asigna a cada nodo para identificarlo. En realidad la mayor parte de las veces para trabajar basta con el número, pero saber algo más no hace daño nunca. <a href="#texto04" className="volver"><img src="/static/volver.png" alt="Volver"></img></a></li>
                <li id="nota05">A pesar de que pueda parecerlo, <abbr>DHTML</abbr> no es ninguna especificación de un lenguaje, sólo un nombre comercial para englobar las propiedades de los modelos de capas y los métodos con los que operar con ellas en las versiones 4 de Explorer y Netscape. Cosa del pasado, vamos. <a href="#texto05" className="volver"><img src="/static/volver.png" alt="Volver"></img></a></li>
                <li id="nota06">Veremos estos conceptos al tratar <a href="curso_4_3_e.php"><code>addEventListener</code></a>. <a href="#texto06" className="volver"><img src="/static/volver.png" alt="Volver"></img></a></li>
            </ol>
