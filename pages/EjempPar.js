...
export default () => (
  <Layout title='EjempPar'>
 <div>
    <div>EjemplosParent</div>
...
<div className='col-md-6'>
    ...
    &lt;p id="otro-parrafo"&gt;&lt;em&gt;Éste&lt;/em&gt; es un párrafo con un &lt;strong&gt;elemento destacado&lt;/strong&gt; en su interior.&lt;/p&gt;
        ...
        <pre><code>{`document.getElementById('otro-parrafo').firstChild;`}</code></pre>
    ...
    document.getElementById('otro-parrafo').getElementsByTagName('em')[0].nextSibling;
        ...
        <pre><code>{`document.getElementById('otro-parrafo').getElementsByTagName('strong')[0].previousSibling;`}</code></pre>
        <p>Probemos.</p>
        <p id="otro-parrafo" class="resultados"><em>Éste</em> es un párrafo con un <strong>elemento destacado</strong> en su interior.</p>
        <p className="boton indep"><button onclick="seleccionar('firstChild');">Seleccionar el primer hijo del párrafo</button></p>
        <p className="boton"><button onclick="seleccionar('lastChild');">Seleccionar el último hijo del párrafo</button></p>
        <p className="boton"><button onclick="seleccionar('nextSibling');">Seleccionar el hermano posterior del elemento <code>em</code></button></p>
        <p className="boton"><button onclick="seleccionar('previousSibling');">Seleccionar el hermano anterior del elemento <code>strong</code></button></p>
    ...
    document.getElementById('otro-parrafo').getElementsByTagName('em')[0].nextSibling.nodeValue;
                    `}</code></pre>
                    <p>Compruébelo:</p>
                    <p className="boton"><button onclick="obtener_valor('lastChild');">Seleccionar el texto del último hijo del párrafo</button></p>
                    <p className="boton"><button onclick="obtener_valor('nextSibling');">Seleccionar el texto del hermano posterior del elemento <code>em</code></button></p>
                    <p className="boton"><button onclick="obtener_valor('previousSibling');">Seleccionar el texto del hermano anterior del elemento <code>strong</code></button></p>
                </li>
    ...
    document.getElementById('otro-parrafo').firstChild.nodeValue;
                    `}</code></pre>
                    <p className="boton indep"><button onclick="texto_em();">Seleccionar el texto dentro de <code>em</code></button></p>
                </li>
            </ul>
        </div>
    ...
    function resaltar_elemento(){
        ...
        <p className="boton"><button onclick="resaltar_elemento();">Resaltar el primer párrafo</button></p>
